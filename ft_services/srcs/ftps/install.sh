...
apk add openssl
openssl req -x509 -nodes -days 365 -newkey rsa:1024 -keyout /etc/ssl/private/vsftpd.pem -out /etc/ssl/private/vsftpd.pem -subj "/C=MA/ST=BENG/L=BENG/O=LEET/CN=$SERVERNAME"
